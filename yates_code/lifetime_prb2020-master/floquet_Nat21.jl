3.3104228040130024, 2.941744767248336, 3.1873340956199185, 3.204769701738966, 3.086026971830903, 3.1500681985691337,
3.1353044088594437, 3.0955568548824495, 3.1654182865335145, 3.140679575362236, 3.135679806065823, 3.125031623739224,
3.1312414141414013, 3.157626133585652, 3.1404793382746212,3.125892272381895, 3.139064846055145, 3.1295891809745013,
3.14451440977356, 3.1340422443134814, 3.170679338148579]]
...
function floquet_ham_interacting_lanczos()
    #L = 60 # number of b_n in Bs_5 = 59
    L=40 #number of bn in BsInt = 39
    # parameters of Hamiltonian
    g = .3
    jx = 1.0
    #Ts = [.5,1.5,3.6,5.,8.25]
    Ts= [0.001,0.00125,0.0015,0.002,0.003,0.005,0.01,0.05] # These are actually Jzs
    Tsnew= [0,0.001,0.005,0.01,0.05] # These are the Jzs that will be eventually plotted
    index = [1,6,7,8] #Picks out element of Ts that will be ultimately plotted. We choose Jz=0.001 (Ts[1]),0.005(Ts[6]),0.01(Ts[7]),0.05(Ts[8])
	...
	bs = BsInt[Ti] #using the data from the beginning of this file for different Jz. Still using Ts to denote the array
	...
	HK = v*Diagonal(shift_energies(u))*v'; u,v = eigen(HK)
        ...
        #=
	HK = v*Diagonal(shift_energies(u) .+ pi)*v'; u,v = eigen(HK)
	println("shifted energies=    ", shift_energies(u) .+ pi)
        =#
    ...
    #= This data is obtained by taking bs_new above, and using mathematica to generate 4-site moving average of absolute dimerizations=#

movav4= [[0.776486, 0.433357, 0.517283, 0.507319, 0.508269, 0.508177, 
  0.508186, 0.508185, 0.508185, 0.508185, 0.508185, 0.508185, 
  0.508185, 0.508185, 0.508185, 0.508185, 0.508185, 0.508185, 
  0.508185, 0.508185, 0.508185, 0.508188, 0.508175, 0.50822, 0.508077,
   0.508492, 0.507427, 0.509807, 0.505261, 0.512722, 0.502374, 
  0.515178, 0.501391, 0.516539, 0.500945], [0.77631, 0.432449, 
  0.523997, 0.457831, 0.650297, 0.62649, 0.551088, 0.671302, 0.495869,
   0.492588, 0.563369, 0.482791, 0.458396, 0.658427, 0.799039, 
  0.859519, 0.832062, 0.652772, 0.508726, 0.403523, 0.357967, 
  0.377623, 0.36907, 0.392398, 0.376117, 0.285062, 0.217084, 0.174737,
   0.164566, 0.12859, 0.109441, 0.0843008, 0.102545, 0.139001, 
  0.112947], [0.776331, 0.43202, 0.526972, 0.443523, 0.638431, 
  0.670612, 0.578496, 0.690172, 0.526319, 0.46924, 0.537252, 0.484813,
   0.444567, 0.633664, 0.79568, 0.882199, 0.864363, 0.681935, 
  0.537481, 0.420152, 0.356769, 0.365445, 0.349907, 0.350493, 
  0.331502, 0.25874, 0.203474, 0.154745, 0.147258, 0.12632, 0.0994391,
   0.0887895, 0.118927, 0.141429, 0.112137], [0.776355, 0.431501, 
  0.530461, 0.42983, 0.617714, 0.694155, 0.580204, 0.688492, 0.540266,
   0.450559, 0.523265, 0.483031, 0.4379, 0.613785, 0.788317, 0.901937,
   0.6665926162944564, 1.1747777728888742, 0.6665917566382809, 1.1747739211701012, 0.6665755814704747, 1.1747106793080622, 0.6663472201064781,
   1.1739566654408662, 0.6640969086027491, 1.167972425935831, 0.650088333453247, 1.1395123324354621, 0.5998071203034444, 1.0622878271074712,
   0.4931868530022124, 0.9274632223084623, 0.32716340436325936, 0.7272652942473325]

   free_data_engs = [-3.14121, -1.8336, -1.81063, -1.77335, -1.72315, -1.66162, -1.59047, -1.51136, -1.42585, -1.33541, -1.24141, -1.14518, -1.04807, -0.951556,
   -0.857377, -0.767682, -0.685243, -0.613645, -0.557273, -0.520837, 0.520837, 0.557273, 0.613645, 0.685243, 0.767682, 0.857377, 0.951556, 1.04807, 1.14518,
   1.24141, 1.33541, 1.42585, 1.51136, 1.59047, 1.66162, 1.72315, 1.77335, 1.81063, 1.8336, 3.14121]

    # rest is plotting. 
    fig,ax = plt.subplots(2,length(Tsnew),sharey = "row", figsize=[6.8,5])
    fig.subplots_adjust(wspace=0.0, hspace = 0.25)
    for (Ti,T) in enumerate(Tsnew)
    	if Ti==1
        ax[1,Ti].plot(free_data_bs[:],"-x", color = "darkorange", ms = 3, lw=0.5)
        ax[2,Ti].plot(free_data_engs[:],"-x", color = "darkorange",ms = 3, lw=0.5)
        ax[2,Ti].axhline(y = -pi,color = "red",alpha = .5)
        ax[2,Ti].axhline(y =  pi,color = "red",alpha = .5)
        ax[2,Ti].axhline(y =  0 ,color = "red",alpha = .5)
        ax[1,Ti].set_xlabel("\$n\$")
        ax[2,Ti].set_xlabel("index")
	ax[1,Ti].text(0.01,1.0,"\$J_z=$(T)\$",transform = ax[1,Ti].transAxes,fontsize = "smaller")
	elseif Ti>1
	Tj = index[Ti-1]
	println("Tj =","  ",Tj, "  ","Jz ="," ", Ts[Tj])
	ax[1,Ti].plot(data_bs[Tj,1,:],"-o",ms = 3, lw=0.5)
        ax[1,Ti].plot(data_bs[Tj,2,:],"-x",ms = 3, lw=0.5)
        ax[2,Ti].plot(data_engs[Tj,1,:],"-o",ms = 3, lw=0.5)
        ax[2,Ti].plot(data_engs[Tj,2,:],"-x",ms = 3, lw=0.5)
        ax[2,Ti].axhline(y = -pi,color = "red",alpha = .5)
        ax[2,Ti].axhline(y =  pi,color = "red",alpha = .5)
        ax[2,Ti].axhline(y =  0 ,color = "red",alpha = .5)
        ax[1,Ti].set_xlabel("\$n\$")
    ...
    ax[2,1].set_ylabel("energy")
     ...
     fig.savefig("fig4a1.png",bbox_inches = "tight",dpi = 800)
    fig.show()

    #println("size of array ", "  ", length(movav4), movav4[[1]])

    markers = ["-o","-s","-^","-*","->","-8","-d","-X","-+"]

    #=Value at n=24 =#

    data2 = [0.392398, 0.350493, 0.319522, 0.26511, 0.168874, 0.0944724, 0.103456, 0.231884] 

    Js = [0,0.001,0.00125,0.0015,0.002,0.003,0.005,0.01,0.05]

    fig,ax = plt.subplots(2,1, figsize=[3.4,6])
    fig.subplots_adjust(hspace = 0.3)
    for i in 1:length(movav4)
    	data = movav4[i]
        ax[1].plot(data[:], markers[i], ms=3.0, lw =1.0, label = "\$ J_z = $(Js[i])\$")
    end
    ax[1].set_xlabel("\$ n \$")
    ax[1].set_ylabel("\$ \\langle |M|\\rangle_4\$")
    
    ax[2].plot(1. ./Ts,data2[:], "-o")
    ax[2].set_xlabel("\$1/J_z\$")
    ax[2].set_ylabel("\$\\langle |M(n=24)|\\rangle_4 \$")
    ...
    fig.savefig("fig4a2.png",bbox_inches = "tight",dpi = 800)
     fig.show()
end
...
function ainf_example_HF()
    ...
    markers = ["-o","-s","-^","-*","->"]
    for (Ti,T) in enumerate(Ts)
        ax.plot(times,data[Ti],markers[Ti],ms= 3.,lw = .5,color = "C$(Ti-1)",label = "\$T = $((2/3)*T) \$") #Here reverting back to free period
    end
    ax.set_xscale("log")
    ax.set_xlabel("\$ t \$")
    ax.set_ylabel("\$ A_\\infty(t) \$")
...
function simple_ainfFL2()
    ...
    #Ls = [8,10,12,14] # different lengths. WARNING, for L=14 do not do more than 100 points
    Ls = [6,8,10]
    # Hamiltonian parameters
    jx = 1.0
    g = .3
    ...
    t_len = collect(range(1,10000,step=1)) # linearly space points
    #t_len = 10 .^ range(0.0,6.0,step =.2) # Logarithmically spaced points
    #t_len = ceil.(10 .^ range(0.0,6.0,step =.2)) # Logarithmically spaced point with only whole periods
    # store results here
    data_ainf1 = zeros(length(t_len),length(Ls)) # exact ainf
    	       	 for (Li,L) in enumerate(Ls) # step through system sizes
               	 sigx = ED.sigX(L,1) # sigma_1^x
               	 println("Jz=",jz," and ", "L=",L," and ","T=",T)
                  # propagator
               	   U1 = exp(-im * T/3 .* ED.H_Delta(L,0.0,0.0,  g,1.0))
              	   U2 = exp(-im * T/3 .* ED.H_Delta(L, jx,0.0,0.0,1.0))
               	   U3 = exp(-im * T/3 .* ED.H_Delta(L,0.0, jz,0.0,1.0))
		  ...
		  quasi_phases,quasi_vecs = eigen(U)
		  sigxv = quasi_vecs'*sigx*quasi_vecs
    		  for (ti,t) in enumerate(t_len)
      		  phases = Diagonal(quasi_phases .^t)
      		  data_ainf1[ti,Li] = 1/(2^L)*real(tr(phases'*sigxv*phases*sigxv))
		   if abs.(data_ainf1[ti,Li])<=exp(-1)*abs.(data_ainf1[1,Li])
		   println("Ainf has decayed: "," ","ti= ",ti," ","t= ", t," ","L=", L," ","jz=",jz)
		    end
    		  end
		  #saving data
		  #save("data21/ainfJztest.jld", "Ls", Ls,"times",t_len,"Ainfs",data_ainf1)
		  save("data21/test.jld", "Ls", Ls,"times",t_len,"Ainfs",data_ainf1)
    		  end
    		...
    		fig,ax = plt.subplots(1,1)
		ax.plot(t_len,data_ainf1[:,1],"*", label="\$ L = $(Ls[1])\$")
		ax.plot(t_len,data_ainf1[:,2],"+", label="\$ L = $(Ls[2])\$")
		ax.plot(t_len,data_ainf1[:,3],"o", label="\$ L = $(Ls[3])\$")
		#ax.plot(t_len,data_ainf1[:,4],"d", label="\$ L = $(Ls[4])\$")
...
# jzs= [0.001,0.00125,0.0015,0.002,0.003,0.005,0.01,0.05,0.1]
# lftime = [1.0e6,630958,398108,251189,100000,39811,15849,631,64]


function read_plot()

#=Data-files: ainfJz0p01_L6-8-10.jld ainfJz0p001.jld ainfJz0p00125.jld
ainfJz0p0015.jld ainfJz0p002.jld ainfJz0p005.jld  ainfJz0p01.jld  ainfJz0p05.jld  ainfJz0p1.jld
=#
       data = load("data21/ainfJz0p01_L6-8-10.jld")
       #data = load("data21/test.jld")
       Ls = data["Ls"]
       times = data["times"]
       ainf = data["Ainfs"]
            #Reads of decay constant
           for (Li,L) in enumerate(Ls) # step through system sizes
	   for (ti,t) in enumerate(times)
           if abs.(ainf[ti,Li])<=exp(-1)*abs.(ainf[1,Li])
		   println("Ainf has decayed: "," ","ti= ",ti," ","t= ", t," ","L=", L)
		   end
	   end
	   end
	        ...
	        #ax.plot(times,ainf[:,1],"*", label="\$ L = $(Ls[1])\$")
		#ax.plot(times,ainf[:,2],"+", label="\$ L = $(Ls[2])\$")
		#ax.plot(times,ainf[:,3],"o", label="\$ L = $(Ls[3])\$")
		#ax.plot(times,ainf[:,4],"d", label="\$ L = $(Ls[4])\$")
    	    	   for (Li,L) in enumerate(Ls)
     	    	   ax.plot(times,ainf[:,Li], markers[Li], ms=3, label = "\$ L = $(Ls[Li])\$")
		   end
			ax.set_xscale("log")
			ax.set_ylabel("\$A_\\infty(nT)\$")
			ax.set_xlabel("\$n\$")
			ax.legend()
			fig.savefig("fig1a.png",bbox_inches = "tight",dpi = 800)
    			plt.show()

			#= Plotting lifetimes vs Jz=#

			#jzs= [0.001,0.00125,0.0015,0.002,0.003,0.005,0.01,0.05,0.1]
			#lftime = [1.0e6,630958,398108,251189,100000,39811,15849,631,64]
		        jzs= [0.001,0.00125,0.0015,0.002,0.003,0.005,0.01]
			lftime = [1.0e6,630958,398108,251189,100000,39811,10000]


#=Something wierd happening with jz=0.01, where all converge to 10000 except L=14 which showd lt= 15849
So I took value for the smaller L=#

			fig,ax = plt.subplots(1,1, figsize=[3.4,4])
			#ax.plot(1. ./jzs,log.(1. ./lftime),"-o",label = "ED Decay rates")
                        ax.plot(1. ./jzs,1. ./lftime,"-o",label = "ED Decay rates")
			ax.set_yscale("log")
			ax.set_ylabel("\$\\Gamma\$")
			ax.set_xlabel("\$1/J_z\$")
   	                plt.legend()
			fig.savefig("fig3a.png",bbox_inches = "tight",dpi = 800)
                        plt.show()
...
function read_plotAinfJzL()

       data1 = load("data21/ainfJz0p001.jld")
       data2 = load("data21/ainfJz0p00125.jld")
       data3 = load("data21/ainfJz0p0015.jld")
       data4 = load("data21/ainfJz0p002.jld")
       data5 = load("data21/ainfJz0p003.jld")
       data6 = load("data21/ainfJz0p005.jld")
       data7 = load("data21/ainfJz0p01.jld")
        
	   Ls = data1["Ls"]

       times = [data1["times"], data2["times"], data3["times"], data4["times"], data5["times"], data6["times"], data7["times"]]
      

       
       ainf = [data1["Ainfs"], data2["Ainfs"], data3["Ainfs"], data4["Ainfs"], data5["Ainfs"], data6["Ainfs"], data7["Ainfs"]]
       ...
       for (jzi, jz) in enumerate(jzs)
	    ...
	    println("jz=   ", jz)
	   #Reads off decay constant
           for (Li,L) in enumerate(Ls) # step through system sizes
	   for (ti,t) in enumerate(times[jzi])
           if abs.(ainf[jzi][ti,Li])<=exp(-1)*abs.(ainf[jzi][1,Li])
		   println("Ainf has decayed: "," ","ti= ",ti," ","t= ", t," ","L=", L)
		   end
	   end
	   end
	   end
	           ainfparity=zeros(length(jzs),length(Ls),length(times[1]))
		   parity = zeros(length(times[1]))
		   for (jzi, jz) in enumerate(jzs)
    	    	   for (Li,L) in enumerate(Ls)
	   	   parity = (-1).^times[jzi]
	   	   println("parity = ", parity)
	   	   ainfparity[jzi,Li,:] = parity[:] .* ainf[jzi][:,Li]
		   end
		   end
	     ...
	     #= PLOTS AINF =#
	     fig,ax = plt.subplots(length(jzs),1,figsize=[3.4,5], sharex=true)
	      fig.subplots_adjust(hspace = 0.0)
	     	   for (jzi, jz) in enumerate(jzs)
    	    	   for (Li,L) in enumerate(Ls)
		   t = times[jzi]
     	    	   ax[jzi].plot(times[jzi],ainf[jzi][:,Li], markers[Li], ms=2.0,label = "\$ L = $(Ls[Li])\$")
		   ax[jzi].text(0.05,0.3,"\$J_z=$(jz)\$",transform = ax[jzi].transAxes,fontsize = "small")
		   end
		   ax[jzi].set_xscale("log")
		   ax[jzi].set_ylabel("\$A_\\infty(nT)\$",labelpad=0.0, fontsize= "small")
		   ax[jzi].tick_params(axis = "both",which = "both",labelsize = "small",
			    direction = "in")

		   end
		    ax[end].set_xlabel("\$n\$")
                     #ax[1].text(.07,.24, transform = ax[1].transAxes)
		     ax[1].legend(loc = "upper center",
		  fontsize = "small",
		  framealpha = 1.0,
		  bbox_to_anchor = (.500,1.6),
		  handlelength = .5,
		  handletextpad = .15,
		  ncol = 4
		  #columnspacing = .5,
		  #labelspacing = .2
		    ...
		    fig.savefig("fig2aOLD1.png",bbox_inches = "tight",dpi = 800)
	     ...
	     fig,ax = plt.subplots(length(jzs),1,figsize=[3.4,5], sharex=true)
	      fig.subplots_adjust(hspace = 0.0)
	     	   for (jzi, jz) in enumerate(jzs)
    	    	   for (Li,L) in enumerate(Ls)
		   t = times[jzi]
     	    	   ax[jzi].plot(times[jzi],abs.(ainf[jzi][:,Li]), markers[Li], ms=2.0,label = "\$ L = $(Ls[Li])\$")
		   ax[jzi].text(0.05,0.3,"\$J_z=$(jz)\$",transform = ax[jzi].transAxes,fontsize = "small")
		   end
		   ax[jzi].set_xscale("log")
		   ax[jzi].set_ylabel("\$|A_\\infty(nT)|\$",labelpad=0.0, fontsize= "small")
		  ...
		  #labelspacing = .2
		    ...
		    fig.savefig("fig2aOLD2.png",bbox_inches = "tight",dpi = 800)

		    plt.show()

		      #= PLOTS (-1)^n (AINF) =#

	     fig,ax = plt.subplots(length(jzs),1,figsize=[3.4,6], sharex=true)
	      fig.subplots_adjust(hspace = 0.05)
	     	   for (jzi, jz) in enumerate(jzs)
    	    	   for (Li,L) in enumerate(Ls)
		   t = times[jzi]
		   ax[jzi].plot(times[jzi],ainfparity[jzi, Li, :], markers[Li], ms=2.0,label = "\$ L = $(Ls[Li])\$")
		   ax[jzi].text(0.05,0.3,"\$J_z=$(jz)\$",transform = ax[jzi].transAxes,fontsize = "small")
		   end
		   ax[jzi].set_xscale("log")
		   ax[jzi].set_ylabel("\$A_\\infty^p(nT)\$",labelpad=0.0, fontsize= "smaller")
		   ax[jzi].tick_params(axis = "both",which = "both",labelsize = "small",
			    direction = "in")
		  ...
		  #labelspacing = .2
		    ...
		    fig.savefig("fig2a.png",bbox_inches = "tight",dpi = 800)
...
#= Reads data, plots it. This is for bn where  save("data21/T8p25_bn.jld", "Ls", Ls,"jzs",jzs,"Bs",Bs)
=#
function read_plotbn()

       data = load("data21/T8p25_bnLz10_12.jld")
       Ls = data["Ls"]
       jzs = data["jzs"]
       Bs = data["Bs"]
       N = length(Bs[:,1,1]) #Should be odd
       Nm = Int.((N-1)/2)  #Number of M0
       println("Number of bns = ", N, " Number of M0 = ", Nm)
       M0 = zeros(Nm,length(jzs)) #Store staggering
       Mend = [] #Store M0 at a certain position 
       for (jzi,jz) in enumerate(jzs)
       println("Jz=  ", jz, "  ", "bn =  ", Bs[:,2,jzi])
       	   for i = 1:Nm
           M0[i,jzi] = -Bs[2*i,2,jzi] + Bs[2*i-1,2,jzi]
           end
	 println("Jz = ",jz, " M0= ",M0[:,jzi], " bns= ", Bs[:,2,jzi])
	 push!(Mend,M0[11,jzi])
       end
      println("Mend = ", Mend)
      ...
      markers = ["-o","-d"]
       ...
       for (jzi,jz) in enumerate(jzs)
	for (Li,L) in enumerate(Ls)
	    ax[jzi].plot(Bs[:,Li,jzi],markers[Li],lw = .5,ms = 1.5,label = "\$ L = $(Ls[Li])\$")
	end
	ax[jzi].text(.72,.1,
		     "\$J_z = $(jz) \$",
		     transform = ax[jzi].transAxes,
		     fontsize = "small")
		     
	ax[jzi].set_ylabel("\$ b_n\$",fontsize = "small")
	ax[jzi].tick_params(axis = "both",which = "both",labelsize = "small",
			    direction = "in")
	ax[jzi].axhline(y =  pi ,color = "black",alpha = .2)		    
    	end
	...
	nl = collect(1:1:length(M0[:,1]))
	println("nl=", nl)
      fig,ax = plt.subplots(1,1,figsize=[3.4,5])
      for (jzi,jz) in enumerate(jzs)
      ax.plot(nl[:],-M0[:,jzi], "-o", lw = 1.0,ms = 2.0, label = "\$J_z =$(jz)\$")
      end
      
      ax.set_xlabel("\$n\$")
      ax.set_ylabel("\$ -M(n)\$")
      ax.legend(fontsize = "smaller", loc= "upper right",
		  #framealpha = 1.0,
		  handlelength = 0.75
		  ,handletextpad = .01
		  )
      ...
      fig,ax = plt.subplots(1,1,figsize=[3.4,4])
	ax.plot(1. ./jzs,-M0[3,:],"-o", label= "\$n=3\$")	  
	ax.plot(1. ./jzs,-M0[5,:],"->", label= "\$n=5\$")	  
	ax.plot(1. ./jzs,-M0[7,:],"-x", label= "\$n=7\$")	  
	ax.plot(1. ./jzs,-M0[9,:],"-s", label = "\$n=9\$")	  
	ax.plot(1. ./jzs,-M0[11,:],"-d", label = "\$n=11\$")
...
#=Genrates plot for paper-2 =#
function floquet_ham_free_lanczos2()
    L = 20
    g = .3
    jx = 1.0
#    Ts = [.5,1.5,3.6,5.,8.25]
    ...
    data_engs = zeros(length(Ts),2*L)
    data_wavef1 = zeros(length(Ts),2*L) 
    data_wavefL = zeros(length(Ts),2*L)
    data_wavefLp1 = zeros(length(Ts),2*L)
    data_wavef2L = zeros(length(Ts),2*L)
    data_bs = zeros(length(Ts),2*L-1)
    ...
    for (Ti,T) in enumerate(Ts)
        ...
        println("T = ", T)
	println("EV = ", u[:])
        println("k=1 EV=", u[1]," and ", "k=L EV=", u[L], " and ", "k=L+1 EV=", u[L+1]," and ","k=2L EV=", u[2*L])
	data_wavef1[Ti,:] = abs.(v[:,1]).^2 # Store the k=1 eigenvector
	data_wavefL[Ti,:] = abs.(v[:,L]).^2  # Store the k=L eigenvector
	data_wavefLp1[Ti,:] = abs.(v[:,L+1]).^2  # Store the k=L+1 eigenvector
	data_wavef2L[Ti,:] = abs.(v[:,2*L]).^2 # Store the k=2*L eigenvector
        data_bs[Ti,:] = bs
	println("bs=",data_bs[Ti,:])
    end
    # rest is plotting
    fig,ax = plt.subplots(2,length(Ts),sharey = "row", figsize = [3.4,5.])
    ...
    #ax[1,1].text(3.1, 0.1, "\$T=8.25\$", transform=ax[1,1].transAxes)
    ax[1,1].set_ylabel("\$ b_n \$")
    ax[2,1].set_ylabel("spectrum of \$H_K\$")
    fig.savefig("fig4a2.png",bbox_inches = "tight",dpi = 800)
    fig.show()
...
#  @timev ainf_example_HF() # ainf example using HF, so micromotion will be off.
...
# @timev simple_ainfFL()
#   @timev read_plotbn() #pap2-OLD PLOT
# @timev dothing()


#THESE ARE USED FOR THE INTERACTING PAPER
# @timev simple_ainfFL2() #GENERATES DATA
#   @timev read_plot() #reads saved data, manilpulates and plots it. PAP2-fig1a, fig3a
#    @timev read_plotAinfJzL() #reads data. PAP2-fig2a
# @timev floquet_ham_interacting_lanczos() # b_ns and shifting energies, interacting, taking data from top. PAP2-fig-4a1-4a2
#   @timev floquet_ham_free_lanczos2() # PAP2-PLOT-3a1
end
